...
class Ui_ImageDialog(QWidget):
    ...
    parser.add_argument('--source', type=str, default='../../../img_fursys/20201013/colorA/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='../../../img_fursys/20201013/output', help='output folder')  # output folder
